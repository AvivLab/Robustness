...
%% FIG 1. Generate diploid fig 1

load("disortstruct.mat");
figure();
subplot(1,2,1);
plot(dimus, disortstruct.avgeigs);
axis([0, 0.5, 0, 2]);
subplot(1,2,2);
plot(dimus, disortstruct.sls);
axis([0, 0.5, 0, 1]);

%% FIG 1S. supplemental diploid fig 1
load("disortstruct2.mat");
figure();
subplot(1,2,1);
plot(dimus, disortstruct2.avgeigs);
axis([0, 0.5, 0, 2]);
subplot(1,2,2);
plot(dimus, disortstruct2.sls);
axis([0, 0.5, 0, 1]);
...
box on;
plot(100:350, p1(i(100:350)),".-b"); hold on;
plot(100:350,p2(i(100:350)),".-r");
