...
axis([0, 0.5, 0, 2]);
title(h1,'(A) Average eigencentrality','FontWeight','bold','fontsize',12);
xlabel(h1,"Mutation rate",'FontWeight','bold','fontsize',12);
ylabel(h1,"Average eigencentrality",'FontWeight','bold','fontsize',12);
fontsize(12,"points")
h2=subplot(1,2,2);
plot(h2,dimus, disortstruct.sls,LineWidth=1.5);
axis([0, 0.5, 0, 1]);
title(h2,'(B) Localization','FontWeight','bold','fontsize',12);
...
xlabel("Genotype",'FontWeight','bold','fontsize',12);
...
plot(100:350,w(100:350),"g", 'LineWidth',2);
for j = 100: 350
    if ps(i(j),7)>eps
        %xline(j);
        plot(j,p2(i(j)),"*r");
