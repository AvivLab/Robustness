...
title(h1,"(A)",'FontWeight','bold','fontsize',18);
...
title(h2,"(B)",'FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
%plot 3: Mesa
...
title(h3,"(C)",'FontWeight','bold','fontsize',12);
set(gca,'fontweight','bold','fontsize',18)
...
xticks(h4,[]);
yticks(h4,[]);
title(h4,"(D)",'FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
xticks(h5,[]);
yticks(h5,[]);
title(h5,"(E)",'FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
xlabel(h1,'viable probability','FontWeight','bold','fontsize',18);
ylabel(h1,'side length of grid','FontWeight','bold','fontsize',18);
title(h1, 'Geometric Russian roulette','FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
xlabel(h2,'viable probability','FontWeight','bold','fontsize',18);
ylabel(h2,'dimension','FontWeight','bold','fontsize',18);
title(h2,'Genetic Russian roulette','FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
xlabel(h3,'viable threshold','FontWeight','bold','fontsize',18);
ylabel(h3,'dimension','FontWeight','bold','fontsize',18);
title(h3,'Mesa Landscape','FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
plot(h1,1-pss,reshape(rob1s(41,:,:),[1050,1]),".");
hold on;
plot(h1, 1-pss,reshape(rob0s(41,:,:),[1050,1]),".r");
axis(h1, [0.69,0.91,0.5,1])
legend(h1, 'final population robustness','initial population robustness','Location','southeast','FontWeight','bold','fontsize',14)
xlabel(h1, 'viable probability','FontWeight','bold','fontsize',18);
ylabel(h1, 'population robustness','FontWeight','bold','fontsize',18);
title(h1, 'Geometric Russian roulette','FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
plot(h2,1-pss2,reshape(rob1s2(7,:,:),[750,1]),".");
hold on;
plot(h2,1-pss2,reshape(rob0s2(7,:,:),[750,1]),".r");
axis(h2,[0.15,0.95,0,1])
legend(h2, 'final population robustness','initial population robustness','Location','southeast','FontWeight','bold','fontsize',14)
xlabel(h2,'viable probability','FontWeight','bold','fontsize',18);
ylabel(h2,'population robustness','FontWeight','bold','fontsize',18);
title(h2,'Genetic Russian roulette','FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
boxplot(h3,myeigs,myrobs);
title(h3,"Genetic (n=12, p=0.2)",'FontWeight','bold','fontsize',18);
xlabel(h3,"Number of neighbors",'FontWeight','bold','fontsize',18);
ylabel(h3,"Normalized eigencentrality",'FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)
...
boxplot(h4,myeigs2,myrobs2);
title(h4,"Genetic (n=10, p=0.75)");
xlabel(h4,"Number of neighbors");
...
title(h1,{'(A) Low-p landscape,', 'uniform starting population'},'FontWeight','bold','fontsize',18);
xlabel(h1,"Mutation rate",'FontWeight','bold','fontsize',18);
ylabel(h1,"Localization",'FontWeight','bold','fontsize',18);
...
plot(h2,mus(1:13),hipstruct.sls(1:13,:),LineWidth=1.5);
set(gca,'fontweight','bold','fontsize',18)
LimitsX = xlim; 
LimitsY = ylim;
h2i=axes('Position',[0.5,0.4,0.1,0.3]);
plot(h2i,mus(9:14),hipstruct.sls(9:14,:));
%title(h2,{'(B) High-p landscape,', 'uniform starting population'},'HorizontalAlignment', 'left', 'position', [LimitsX(1), LimitsY(2)],'FontWeight','bold','fontsize',12);
title(h2,{'(B) High-p landscape,', 'uniform starting population'}, 'FontWeight','bold','fontsize',18);
...
LimitsX = xlim;
LimitsY = ylim;
%title(h3,{'(C) Low-p landscape,', 'isogenic starting population'},'HorizontalAlignment', 'left', 'position', [LimitsX(1), LimitsY(2)],'FontWeight','bold','fontsize',12);
title(h3,{'(C) Low-p landscape,', 'isogenic starting population'}, 'FontWeight','bold','fontsize',18);
xlabel(h3,"Mutation rate",'FontWeight','bold','fontsize',18);
ylabel(h3,"Localization",'FontWeight','bold','fontsize',18);
set(gca,'fontweight','bold','fontsize',18)

sgtitle('Localization of stationary distributions under different conditions','FontWeight','bold','fontsize',24 )
...
sgtitle('Distance of stationary distribution to eigencentrality under different conditions','FontWeight','bold','fontsize',24 )
...
q.Color="red";
q.LineStyle="--";
lgd=legend(h1,[p,q],["Average","Baseline"]);
lgd.FontSize=11;
title(h1,{'(A) Low-p landscape,', 'uniform starting population'},'FontWeight','bold','fontsize',18);
xlabel(h1,"Mutation rate",'FontWeight','bold','fontsize',18);
%ylabel(h1,"Localization",'FontWeight','bold','fontsize',12);
fontsize(18,"points")
set(gca,'fontweight','bold','fm…ze',18)
...
sgtitle('Average Normalized Eingencentrality','FontWeight','bold','fontsize',24 )
%%
...
sgtitle('Normalized Eigencentrality of the Mode','FontWeight','bold','fontsize',24);
...
G=graph(A==1);
l=length(X);
sgtitle('One Landscape 4 Basins of Attraction','FontWeight','bold','fontsize',24);
