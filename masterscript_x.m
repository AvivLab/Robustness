...
xlabel(h2,'viable probability','FontWeight','bold','fontsize',12);
ylabel(h2,'dimension','FontWeight','bold','fontsize',12);
title(h2,'Genetic Russian roulette','FontWeight','bold','fontsize',12);
set(gca,'fontweight','bold','fontsize',18)
...
xlabel(h3,'viable threshold','FontWeight','bold','fontsize',12);
ylabel(h3,'dimension','FontWeight','bold','fontsize',12);
title(h3,'Mesa Landscape','FontWeight','bold','fontsize',12);
set(gca,'fontweight','bold','fontsize',18)
...
legend(h1, 'final population robustness','initial population robustness','Location','southeast','FontWeight','bold','fontsize',12)
xlabel(h1, 'viable probability','FontWeight','bold','fontsize',12);
ylabel(h1, 'population robustness','FontWeight','bold','fontsize',12);
title(h1, 'Geometric Russian roulette','FontWeight','bold','fontsize',12);
set(gca,'fontweight','bold','fontsize',18)
...
legend(h2, 'final population robustness','initial population robustness','Location','southeast','FontWeight','bold','fontsize',12)
xlabel(h2,'viable probability','FontWeight','bold','fontsize',12);
ylabel(h2,'population robustness','FontWeight','bold','fontsize',12);
title(h2,'Genetic Russian roulette','FontWeight','bold','fontsize',12);
set(gca,'fontweight','bold','fontsize',18)
...
title(h3,"Genetic (12,0.2)",'FontWeight','bold','fontsize',12);
xlabel(h3,"Number of neighbors",'FontWeight','bold','fontsize',12);
ylabel(h3,"Normalized eigencentrality",'FontWeight','bold','fontsize',12);
set(gca,'fontweight','bold','fontsize',18)
...
title(h1,{'(A) Low-p landscape,', 'uniform starting population'},'FontWeight','bold','fontsize',12);
...
title(h2,{'(B) High-p landscape,', 'uniform starting population'}, 'FontWeight','bold','fontsize',12);
...
title(h3,{'(C) Low-p landscape,', 'isogenic starting population'}, 'FontWeight','bold','fontsize',12);
xlabel(h3,"Mutation rate");
ylabel(h3,"Localization");
set(gca,'fontweight','bold','fontsize',18)

sgtitle('Localization of stationary distributions under different conditions','FontWeight','bold','fontsize',20 )
...
title(h1,{'(A) Low-p landscape,', 'uniform starting population'},'FontWeight','bold','fontsize',12);
xlabel(h1,"Mutation rate",'FontWeight','bold','fontsize',12);
...
title(h2,{'(B) High-p landscape,', 'uniform starting population'}, 'FontWeight','bold','fontsize',12);
xlabel(h2,"Mutation rate",'FontWeight','bold','fontsize',12);
...
quantplot(h3,x,mus);
title(h3,{'(C) Low-p landscape,', 'isogenic starting population'}, 'FontWeight','bold','fontsize',12);
xlabel(h3,"Mutation rate",'FontWeight','bold','fontsize',12);
%ylabel(h3,"Localization",'FontWeight','bold','fontsize',12);
fontsize(12,"points")

sgtitle('Distance of stationary distribution to eigencentrality under different conditions','FontWeight','bold','fontsize',16 )
...
sgtitle('Average Normalized Eingencentrality','FontWeight','bold','fontsize',16 )
%%
...
sgtitle('Normalized Eigencentrality of the Mode','FontWeight','bold','fontsize',16);
...
G=graph(A==1);
l=length(X);
sgtitle('One Landscape 4 Basins of Attraction','FontWeight','bold','fontsize',16);
